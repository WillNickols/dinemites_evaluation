...
parameters <- '~/Documents/GitHub/dinemites_evaluation/scripts/config/qpcr_testing.txt'
...
input_path <- '~/Documents/GitHub/dinemites_evaluation/qpcr/output/'
...
if (!file.exists('~/Documents/GitHub/dinemites_evaluation/evaluation_intermediates/qpcr_evaluation.RDS')) {
    # num_cores <- 1
    ...
    saveRDS(growing_df_save, file = '~/Documents/GitHub/dinemites_evaluation/evaluation_intermediates/qpcr_evaluation.RDS')
} else {
    growing_df_save <- readRDS('~/Documents/GitHub/dinemites_evaluation/evaluation_intermediates/qpcr_evaluation.RDS')
}
